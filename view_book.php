    ...
    <div class="col-12">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div><span class="text-muted">Author: </span><?php echo $author ?></div>
                <div class="lh-1">
    ...
    <div class="col-12">
        ...
        <?php if(!isset($_GET['order_id'])): ?>
            <div class="col-auto mx-1">
                <div class="btn btn btn-primary btn-sm rounded-0" id="add_to_favorite" type="button">Add to Favorite</div>
            </div>
            <?php endif; ?>
            <div class="col-1">
    ...
    $(function(){
        ...
        $('#add_to_favorite').click(function(){
            ...
            if('<?php echo isset($_SESSION['user_id']) && $_SESSION['user_id'] > 0 ?>' == 1){
                $.ajax({
                    url:"Actions.php?a=add_to_favorite",
                    method:"POST",
                    ...
                    success:function(resp){
                        if(resp.status == "success"){
                            ...
                            alert("The SLR is added to your favorite");
