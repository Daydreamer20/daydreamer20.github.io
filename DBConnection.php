...
if(!is_dir(__DIR__.'./db'))
    mkdir(__DIR__.'./db');
if(!defined('db_file')) define('db_file',__DIR__.'./db/slrs_db.db');
...
Class DBConnection extends SQLite3{
    ...
    function __construct(){
        ...
        $this->exec("CREATE TABLE IF NOT EXISTS `favorite_list` (
        ...
        $this->exec("INSERT or IGNORE INTO `admin_list` VALUES (1,'Administrator','BLRTAII',md5('1234admin'),1, CURRENT_TIMESTAMP)");
