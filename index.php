...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | LIST OF APPROVED SUPPLEMENTARY LEARNING RESOURCES</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark bg-gradient" id="topNavBar">
        <div class="container">
            ...
            LIST OF APPROVED SUPPLEMENTARY LEARNING RESOURCES
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link <?php echo $page == "books" ? "active" :"" ?>" href="./?page=books">Home</a>
                    </li>
                    <?php if(isset($_SESSION['user_id']) && $_SESSION['user_id'] > 0): ?>

                    <li class="nav-item">
                        <?php 
                         $count = $conn->query("SELECT count(book_id) as total FROM `favorite_list` where `user_id` = '{$_SESSION['user_id']}'")->fetchArray()['total'];
                        ?>
                        <a class="nav-link <?php echo $page == "favorite" ? "active" :"" ?>" href="./?page=favorite">Favorite <span id="favorite_count" class="badge badge-pill bg-light text-dark"><?php echo $count > 0 ? $count : 0 ?></span></a>
                    </li>
                    <?php endif; ?>
