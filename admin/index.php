...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | LIST OF APPROVED SUPPLEMENTARY LEARNING RESOURCES Admin page</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./?page=maintenance">Category list</a>
                    </li>
